<?php /* C:\wamp64\www\htdocs\27-Centre-auto-87\wp-content\plugins\akeebabackupwp\app\Solo\ViewTemplates\Sysconfig\appsetup.blade.php */ ?>
<?php
/**
 * @package   solo
...
<div class="akeeba-form-group">
    <label for="timezone">
        <?php if($inCMS): ?>
            <?php echo \Awf\Text\Text::_('SOLO_SETUP_LBL_TIMEZONE_WP'); ?>
        <?php else: ?>
...
<div class="akeeba-form-group">
    ...
    <p class="akeeba-help-text">
        <?php if($inCMS): ?>
		    <?php echo \Awf\Text\Text::_('COM_AKEEBA_CONFIG_BACKEND_LOCALTIME_WP_DESC'); ?>
        <?php else: ?>
...
<div class="akeeba-form-group">
    ...
    <p class="akeeba-help-text">
        <?php if($inCMS): ?>
		    <?php echo \Awf\Text\Text::_('COM_AKEEBA_CONFIG_FORCEDBACKUPTZ_WP_DESC'); ?>
        <?php else: ?>
