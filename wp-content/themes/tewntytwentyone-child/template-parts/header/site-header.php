...
<section class="upper-header">
    <div class="wrapper">
        <a href="mailto:recup.auto87@outlook.fr"><img src="<?= get_home_url() . '/wp-content/themes/tewntytwentyone-child/assets/images/pictos/email-picto.png'; ?>" alt="Téléphone"> recup.auto87@outlook.fr</a>
        <a href="tel:+33625326065"><img src="<?= get_home_url() . '/wp-content/themes/tewntytwentyone-child/assets/images/pictos/phone-picto.png'; ?>" alt="Email">06 25 32 60 65</a>
    </div>
</section>
