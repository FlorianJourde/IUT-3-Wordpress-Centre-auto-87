        ...
        <div class="text-with-button">
            ...
            if ($parts['query']) {
                ...
                <div class="buttons-wrapper">
                        <img class="brand" src="<?= get_home_url() . '/wp-content/themes/tewntytwentyone-child/assets/images/brands/' . strtolower($_GET['marque']) . '-automobile-logo.png'; ?>" alt="<?= $_GET['marque'] ?> automobile logo">
                </div>
